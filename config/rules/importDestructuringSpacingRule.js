...
var Rule = (function (_super) {
  ...
  Rule.prototype.apply = function (sourceFile) {
    return this.applyWithWalker(
      new ImportDestructuringSpacingWalker(sourceFile, this.getOptions()));
  };
...
var ImportDestructuringSpacingWalker = (function (_super) {
  ...
  function ImportDestructuringSpacingWalker(sourceFile, options) {
    ...
    this.scanner =
      ts.createScanner(ts.ScriptTarget.ES5, false, ts.LanguageVariant.Standard,
        sourceFile.text);
  }

  ImportDestructuringSpacingWalker.prototype.visitImportDeclaration =
    function (node) {
      ...
      if (importClause != null && importClause.namedBindings != null) {
        ...
        if (!this.checkForWhiteSpace(text)) {
          this.addFailure(
            this.createFailure(importClause.namedBindings.getStart(),
  ...
  ImportDestructuringSpacingWalker.prototype.checkForWhiteSpace =
    function (text) {
